...
class TemperatureTest {
  ...
  void convertCelsiusToFarenheit() {
    assertThat(Temperature.celsius(65.32).toFarenheit()).isEqualTo(Temperature.farenheit(149.57));
  }
  ...
  void convertFarenheitToFarenheit() {
    assertThat(Temperature.farenheit(103.23).toFarenheit()).isEqualTo(Temperature.farenheit(103.23));
  }
  ...
  void convertKelvinToFarenheit() {
    assertThat(Temperature.kelvin(103.23).toFarenheit()).isEqualTo(Temperature.farenheit(-273.86));
  }
