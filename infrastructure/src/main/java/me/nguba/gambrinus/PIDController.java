...
public class PIDController
{
     ...
     */
    private static boolean bounded(final double value, final double min, final double max)
    {
    ...
    /**
     * Create a MiniPID class object. See setP, setI, setD, setF methods for more detailed
     * parameters.
     *
     * @param p
     *            Proportional gain. Large if large difference between setpoint and target.
    ...
    /**
     * Resets the controller. This erases the I term buildup, and removes D gain on the next
     * loop.<br>
     ...
     * <li>Adds "drag" and slows the system when moving toward the target </list> A small D value
     * can be useful for both improving response times, and preventing overshoot. However, in many
     * systems a large D value will cause significant instability, particularly for large setpoint
     * changes. <br>
     ...
     * This is excellent for velocity, rate, and other continuous control modes where you can expect
     * a rough output value based solely on the setpoint.<br>
     ...
     * This can prevent sharp jumps in output when changing setpoints or enabling a PID system,
     * which might cause stress on physical or electrical systems. <br>
